...
final class AuthManager {
    ...
    struct Constants {
        static let clientId = "0e867c78f454481db951f25bc7cdc443"
        static let clientSecret = "6d1b395c9f784450a51a7c0247cea741"
    ...
    public var signInURL : URL? {
        ...
        let myURL = "\(base)?response_type=code&client_id=\(Constants.clientId)&scope=\(scopes)&redirect_uri=\(Constants.redirectURI)&show_dialog=TRUE"
    ...
    public func exchangeCodeForToken(
        ...
        components.queryItems = [
            ...
            URLQueryItem.init(name: "redirect_uri", value: Constants.redirectURI),
        ]
